const menu = [
  ...
  },
  {
    ...
    price: 5.99,
    img:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGNTQpXhq0-6qxKL16MxiZ6iwZFF66_-HocKmzWfJfmg&s",
...
// menülerin sayfada gösterilmesi icin yazilmis fonksiyon. Category all ise hepsini degilse filter methodu kullanilarak click eventi aktif edilen buton ile ilgili kategorinin yemekleri gosterilecek.
...
// sayfa ilk yüklendiginde butun yemeklerin gosterilmesi icin.
window.addEventListener("DOMContentLoaded", () => showMenu("All"));

// ilgili butona tiklandiginda ilgili menunun gosterimi.
